...
| 12 | Haptics | Every XR project | Candidate, source gate passed | Named haptic events and per-controller profiles behind an engine-light intent seam; every shape in the shipped-game gap matrix needs it in the first minute of play |
