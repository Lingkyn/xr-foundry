    ...
    public sealed class InventoryXrPrefabAndValidationTests
    {
        ...
        public void ValidatorRejectsMissingDuplicateDisabledAndDesktopInputModules()
        {
            ...
            try
            {
                ...
                Assert.That(InventoryXrSceneValidator.ValidateScene(surface, Array.Empty<EventSystem>())
                ...
                Assert.That(InventoryXrSceneValidator.ValidateScene(surface, new[] { desktop })
                ...
                Assert.That(InventoryXrSceneValidator.ValidateScene(surface, new[] { xrSystem }).IsValid, Is.True);

                xrSystem.enabled = false;
                Assert.That(InventoryXrSceneValidator.ValidateScene(surface, new[] { xrSystem })
                ...
                Assert.That(InventoryXrSceneValidator.ValidateScene(surface, new[] { xrSystem, desktop })
            ...
            {
                DestroyImmediate(xrObject, desktopObject, cameraObject, instance);
            }
        }
