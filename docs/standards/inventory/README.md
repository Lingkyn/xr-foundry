...
Implementation status: **Core and Unity authoring are candidate; UGUI `0.1.1`
functional-prefab correction is under validation; XR pending**
...
| `com.lingkyn.inventory.ugui` | Incubating `0.1.1`; functional shipped prefabs and local prefab-backed tests pass; the `0.1.0` structure-only verdict is withdrawn | Immutable Git consumer, sample import, upgrade/rollback, and candidate review |
