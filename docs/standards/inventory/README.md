...
Implementation status: **Core and Unity authoring admitted at candidate maturity;
UGUI implemented at incubating maturity; XR pending**
...
| `com.lingkyn.inventory.ugui` | Implemented, incubating; presenter, nested prefab, replacement, state, and local interaction tests pass | Immutable non-XR Git consumer and candidate review |
