...
| XR | Provider-neutral world-space/nested prefab; fail-closed scene validation; non-head-locked placement; tracked-ray left/center/right and real XRI poke PlayMode routes; local clean-consumer EditMode/PlayMode; Package Manager sample import/compile/setup | Immutable Git clean consumer | Incubating XR adapter only; no headset usability claim |
