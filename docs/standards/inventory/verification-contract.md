...
| UGUI | Presenter boundary; independent nested prefab roles/variant; slot replacement; all required states; pointer/keyboard PlayMode test | Immutable Git consumer without XR packages and candidate review | Incubating UGUI evaluation only |
