...
| Unity authoring | ScriptableObject assets; stable IDs; deterministic conversion; actionable diagnostics; asset immutability; local clean-consumer EditMode tests | Immutable Git URL clean consumer and candidate review | Incubating Unity authoring evaluation only |
