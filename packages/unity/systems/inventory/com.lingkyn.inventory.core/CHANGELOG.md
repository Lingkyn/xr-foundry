...
- Added six EditMode tests named by the Core coverage map: empty-slot and
  over-quantity removal, non-positive stack quantities, exact stack and capacity
  boundaries, unknown container and invalid slot, occupied transfer destination,
  and multi-seed invariant sequences with a unique instance. No runtime change.
  Editor execution is pending.
