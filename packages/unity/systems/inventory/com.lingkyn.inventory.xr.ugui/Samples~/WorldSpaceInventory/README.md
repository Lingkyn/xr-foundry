# World-Space Inventory UGUI sample
...
It also requires the consumer rig to already provide at least one active XRI UI
interactor. The command deliberately fails closed instead of fabricating a
controller, XR Origin, input action, or provider-specific route.
